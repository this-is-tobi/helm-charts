...
![Version: 2.5.6](https://img.shields.io/badge/Version-2.5.6-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.4.3](https://img.shields.io/badge/AppVersion-1.4.3-informational?style=flat-square)
...
```sh
helm install <release_name> oci://ghcr.io/this-is-tobi/helm-charts/backup-utils --version 2.5.6
```
