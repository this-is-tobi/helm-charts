...
| postgresql.image.tag | string | `"1.4.2"` | Tag to use for the postgresql backup. # Overrides the image tag whose default is the chart appVersion. |
...
| vault.image.tag | string | `"1.1.2"` | Tag to use for the vault backup. # Overrides the image tag whose default is the chart appVersion. |
